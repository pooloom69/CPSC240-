...
;		 
; Purpose:
; input_array(double* out_array, long max_len) -> long count
; Reads up to max_len 64-bit floats from stdin, validates each as a float,
; converts to double, and stores into out_array. Returns the number stored.
;
; Project Information:
